...
##example 1:
##There is a data set "mixture_data1" that includes a quantitative trait and the genotype of target SNP of 30 pedigrees with 260 individuals (130 females and 130 males) and additional 130 unrelated females.
...
##The first five columns should be consistent with that in the data "mixed_data1". The last two columns are the covariates we want to add. "covariate1" is quantitative and "covariate2" is qualitative.
...
set.seed(123456)
M_Bayes_XCI(mixed_data=mixed_data_1, covariate=covariate_data_mixed_1, trait_type="quantitative", trait_missing=NA,
...
##example 2:
##mixed data for quantitative trait with covariates.
##the prior of gamma is set to uniform distribution and other parameters are set to defaults.
set.seed(123456)
M_Bayes_XCI(mixed_data=mixed_data_1,covariate=covariate_data_mixed_1,trait_type="quantitative",
            gamma_prior="uniform")
#results:
#SNP_Name Point_Estimate HPDI_Lower HPDI_Upper   Rhat
...
##example 4:
##mixed data for qualitative trait with covariates.
##you want to customize the prior of gamma and other unknown parameters.
...
set.seed(123456)
M_Bayes_XCI(mixed_data=mixed_data_3,covariate=covariate_data_mixed_2,trait_type="qualitative",
            gamma_prior="customize",prior_customize=prior_customize)
#results:
#SNP_Name Point_Estimate HPDI_Lower HPDI_Upper   Rhat
...
##example 5:
##mixed data for quantitative trait with covariates and missing values.
##the prior of gamma is set to truncated normal distribution and other parameters are set to defaults.
set.seed(123456)
M_Bayes_XCI(mixed_data=mixed_data_2,covariate=covariate_data_mixed_1,trait_type="quantitative",
            gamma_prior="normal")
#results:
#SNP_Name Point_Estimate HPDI_Lower HPDI_Upper   Rhat
...
##example 6:
##mixed data for qualitative trait with covariates and missing values.
##the prior of gamma is set to truncated normal distribution and other parameters are set to defaults.
set.seed(123456)
M_Bayes_XCI(mixed_data=mixed_data_4,covariate=covariate_data_mixed_2,trait_type="qualitative",
            gamma_prior="normal")
#results:
#SNP_Name Point_Estimate HPDI_Lower HPDI_Upper   Rhat
...
##example 7:
##mixed data for quantitative trait without covariates.
##the prior of gamma is set to truncated normal distribution and other parameters are set to defaults.
set.seed(123456)
M_Bayes_XCI(mixed_data=mixed_data_1,covariate=NULL,trait_type="quantitative",
            gamma_prior="normal")
#results:
#SNP_Name Point_Estimate HPDI_Lower HPDI_Upper   Rhat
...
##example 8:
##mixed data for qualitative trait without covariates.
##the prior of gamma is set to truncated normal distribution and other parameters are set to defaults.
set.seed(123456)
M_Bayes_XCI(mixed_data=mixed_data_3,covariate=NULL,trait_type="qualitative",
            gamma_prior="normal")
#results:
#SNP_Name Point_Estimate HPDI_Lower HPDI_Upper   Rhat
...
##example 1:
##There is a data set "pedigree_data_1" that includes a quantitative trait and the genotype of target SNP of 30 pedigrees with 260 individuals (130 females and 130 males).
##There is the corresponding covariate data "covariate_data_pedigree_1" for above individuals.
...
head(covariate_data_pedigree_1)
## famid iid fid mid sex covariate1 covariate2
##    1   1   0   0   1      -0.49          0
##    1   2   0   0   2       0.32          0
##    1   3   1   2   1       1.46          1
...
set.seed(123456)
P_Bayes_XCI(pedigree_data=pedigree_data_1, covariate=covariate_data_pedigree_1, trait_type="quantitative", trait_missing=NA,
            genotype_missing=NA, covariate_missing=NA, gamma_prior="normal",
            prior_customize=NULL, chains_num=4, parallel_chains=4,
            iter_num=2000, warmup_num=1000, acceptance_rate=0.9, decimal=4)
#results:
